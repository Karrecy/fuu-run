...
import EventEmitter from 'E:/git/fuu-run/fuu-run-admin/node_modules/event-emitter';
// @ts-ignore
import warning from 'E:/git/fuu-run/fuu-run-admin/node_modules/warning';
...
import lang_bnBD0 from "E:/git/fuu-run/fuu-run-admin/src/locales/bn-BD.ts";
import enUS0 from 'antd/es/locale/en_US';
import lang_enUS0 from "E:/git/fuu-run/fuu-run-admin/src/locales/en-US.ts";
import faIR0 from 'antd/es/locale/fa_IR';
import lang_faIR0 from "E:/git/fuu-run/fuu-run-admin/src/locales/fa-IR.ts";
import idID0 from 'antd/es/locale/id_ID';
import lang_idID0 from "E:/git/fuu-run/fuu-run-admin/src/locales/id-ID.ts";
import jaJP0 from 'antd/es/locale/ja_JP';
import lang_jaJP0 from "E:/git/fuu-run/fuu-run-admin/src/locales/ja-JP.ts";
import ptBR0 from 'antd/es/locale/pt_BR';
import lang_ptBR0 from "E:/git/fuu-run/fuu-run-admin/src/locales/pt-BR.ts";
import zhCN0 from 'antd/es/locale/zh_CN';
import lang_zhCN0 from "E:/git/fuu-run/fuu-run-admin/src/locales/zh-CN.ts";
import zhTW0 from 'antd/es/locale/zh_TW';
import lang_zhTW0 from "E:/git/fuu-run/fuu-run-admin/src/locales/zh-TW.ts";
