...
/// <reference types="E:/git/fuu-run/fuu-run-admin/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "E:/git/fuu-run/fuu-run-admin/node_modules/@ant-design/pro-components";
import './Layout.css';
