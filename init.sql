...
) ENGINE = InnoDB AUTO_INCREMENT = 161 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户地址表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4077 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资金流动表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `money_recode`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_uid`(`uid` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '提现审核表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `oss_config` VALUES (1, 'qiniu', 'xxx', 'xxx', 'xxx-x', 'xxx-x', 'xxx', 'xxx', 'Y', '', '1', '1', '', '2024-12-05 06:06:42', NULL, '161111');
INSERT INTO `oss_config` VALUES (2, 'minio', 'XXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXX', '', 'XXXXXXXXXXXXXXX', '', 'N', '', '1', '0', '', '2024-12-05 06:06:42', NULL, NULL);
...
INSERT INTO `perm` VALUES (3207, '提交提现菜单', 3200, 0, 'payment:applyForWithdrawal:view');
...
INSERT INTO `role_perm` VALUES (1, 3207);
...
INSERT INTO `role_perm` VALUES (1, 6803);
...
CREATE TABLE `runner_apply`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '跑腿申请表\r\n' ROW_FORMAT = DYNAMIC;
...
-- Records of school
-- ----------------------------
INSERT INTO `school` VALUES (4, 226, '350121', '福州大学(旗山校区)', 'https://qiniu.singoval.com/fuu-run/2025/05/09/08cf35a39eb7415f85ced5b287039171png', '2025-05-09 18:12:00', '2025-05-09 18:12:00', 1, 2, 2, 96, 1.00);
...
CREATE TABLE `school_region`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_school_id`(`school_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 246 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学校楼栋管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of school_region
-- ----------------------------
INSERT INTO `school_region` VALUES (233, 4, 0, '快递站', NULL, NULL, NULL, NULL, '2025-05-19 17:31:51', 226, '2025-05-19 17:31:51', 226);
INSERT INTO `school_region` VALUES (234, 4, 1, '福大校内快递点', '119.192088', '26.049572', 233, NULL, '2025-05-19 17:34:00', 226, '2025-05-19 17:34:00', 226);
INSERT INTO `school_region` VALUES (235, 4, 1, '福大校内邮政', '119.192753', '26.056213', 233, NULL, '2025-05-19 17:36:22', 226, '2025-05-19 17:36:22', 226);
INSERT INTO `school_region` VALUES (236, 4, 1, '学生街快递站', '119.190720', '26.058883', 233, NULL, '2025-05-19 17:36:57', 226, '2025-05-19 17:36:57', 226);
...
CREATE TABLE `statistics_daily`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 115 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '每日数据统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tags`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_school_id`(`school_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'tag表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 263 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '全局用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (100, 0, '2024-11-30 08:28:07', '2025-06-05 19:18:56', '27.148.88.246', '中国|福建省|福州市|电信', 0, 100, '2025-04-18 03:27:22', 100);
...
) ENGINE = InnoDB AUTO_INCREMENT = 141 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '平台管理员表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user_pc
-- ----------------------------
INSERT INTO `user_pc` VALUES (100, 100, 'admin', '$2a$10$MFUq99MOgltc0S9VcbNqFezQajdnKDrLZbj9F0Ihb7uVeQXf413LK', '15612345678', '阿涛', 'url', 'url', 1, 1, 'https://qiniu.singoval.com/2025/04/18/c41ba14aedd74e23af8f5e9d74784ec0jpg', '1162251585@qq.com', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 231 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '小程序普通用户表' ROW_FORMAT = DYNAMIC;
...
-- Records of wallet
-- ----------------------------
INSERT INTO `wallet` VALUES (100, 0.00, 2.61, '2025-02-18 11:43:19', '2025-06-05 14:11:39');
